// Config
export { loadConfig, CLAUDE_PROJECT_DIR } from "./config/loader"
export { validateConfig, desugarFileInjections } from "./config/schema"
export { buildFileRegistry } from "./config/files"
export type { ReferenceFile, FileRegistry } from "./config/files"

// Types
export type {
  RCTConfig, GlobalsConfig, FileEntry, MetaFileEntry,
  LangConfig, LangEntry, LangTool, LangConfigFile,
  TestConfig, RuleEntry, MatchCondition, InjectionEntry,
  MetaConfig, HookEvent, FileRef, Match, MatchTarget, MatchOperator
} from "./config/types"
